...
stopwords = set([
			...
			'&amp;', "can't", "@", 'get', 'go', 'others', 'one', 'really', 'time', 
			'still', 'back', 'w/', 'going', 'know', 'got', 'would', "ain't", 'first',
			'night', "she's", 'things', 'could', "we're", "you'll", "isn't", "what's",
			'i', 'me', 'my', 'myself', 'we', 'our', 'ours', 'ourselves', 'stuff', 
			'please',
